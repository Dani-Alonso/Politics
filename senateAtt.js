...
avgT += allMembers[i].votes_with_party_pct;
        ...
        if (allMembers[i].party == "I") {
            ...
            avgI = avgI + allMembers[i].votes_with_party_pct;
        }
    }
    ...
    statistics.numberOfIndependents = comptadorI.length;
...
function selectedMostSenate() {
    ...
    app.dataMost = selectedMostAttenSen;
}
...
//        if (si es republica) {
//
//            comptadorR = comptadorR + 1;
//
//        }
//        if (si es dem) {
//
//            comptadorD = comptadorD + 1;
//        }
//        if (si es inde) {
//            comptadorI = comptadorI + 1;
//        }
//    }
//
//    statistics.numberOfRepubicans = comptadorR;
//    statistics.numberOfDemocrats = comptadorD;
//    statistics.numberOfIndependents = comptadorI;
//}
//
//
//
...
//
//
//} // creo un object Json donde pongo los valores que nos piden
//
//{
//    "numberDemocrtats": ,
//    "%VotedW/Party":
