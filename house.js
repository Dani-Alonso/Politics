...
fetch("https://api.propublica.org/congress/v1/113/house/members.json", {
    ...
    data = json;
    tablaHouse.members = data.results[0].members;
...
var houseTableBody = document.getElementById("houseTable");
...
//
//
//        houseTableBody.appendChild(trsena);
//
//    }
//}
//
...
function getSelectedMembers(array) {
    ...
    for (var i = 0; i < array.length; i++) {
        ...
        if (cbI.checked && array[i].party == "I" && (dpD.value == "All States" || dpD.value == data.results[0].members[i].state)) {
